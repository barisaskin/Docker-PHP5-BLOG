						...
						<ul class="w3-ul w3-hoverable w3-white">
							...
							while($yaz=mysql_fetch_object($sorgu)){
								echo "<li class='w3-padding-16'>
										<a href='".Site_url."/index.php?sayfa=kategori/$yaz->url'>
					...
					<?php 
						if($url[0]=="" or $url[0]=="anasayfa"){
							...
							for($i=1;$i<ceil($toplam/$per_page)+1;$i++){
								if($sayfa==$i){
									echo "<a href='".Site_url."/index.php?sayfa=anasayfa/sayfa/$i' class='w3-button w3-black w3-disabled w3-padding-large w3-margin-bottom'>$i</a>";
								}else{
									echo "<a href='".Site_url."/index.php?sayfa=anasayfa/sayfa/$i' class='w3-button w3-black w3-padding-large w3-margin-bottom'>$i</a>";
								}
							} 
							echo "</div>";
						}else if($url[0]=="ara"){
							...
							if($toplam>0){
								...
								echo "	<div class='w3-card-4 w3-margin w3-white'>
											<a href='".Site_url."/index.php?sayfa=yazi/$yaz->url'><img src='".Site_url."/images/kategori/$yaz2->resim' style='width:100%'></a>
										...
										while($yaz3=mysql_fetch_object($sorgu3)){
											echo "
												<div class='w3-card-4 w3-margin w3-white'>
													<p><b>$yaz3->email</b></p>
													<p>".htmlspecialchars($yaz3->yorum)."</p>
												</div>";
										}
										echo "	<div class='w3-card-4 w3-margin w3-white'>
													<form method='post'>
							...
							for($i=1;$i<ceil($toplam/$per_page)+1;$i++){
								if($sayfa==$i){
									echo "<a href='".Site_url."/index.php?sayfa=kategori/$url1/sayfa/$i' class='w3-button w3-black w3-disabled w3-padding-large w3-margin-bottom'>$i</a>";
								}else{
									echo "<a href='".Site_url."/index.php?sayfa=kategori/$url1/sayfa/$i' class='w3-button w3-black w3-padding-large w3-margin-bottom'>$i</a>";
								}
							} 
							echo "</div>";
						}
