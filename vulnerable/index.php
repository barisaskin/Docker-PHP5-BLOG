...
<html>
	<head>
        ...
        <!--<link rel="stylesheet" href="<?php echo Site_url_index_vulnurable;?>/css/w3.css">-->
						...
						<ul class="w3-ul w3-hoverable w3-white">
							...
							while($yaz=mysql_fetch_object($sorgu)){
								echo "<li class='w3-padding-16'>
										<a href='".Site_url_index_vulnurable."/index.php?sayfa=kategori/$yaz->url'>
											<img src='".Site_url_index_vulnurable."/images/kategori/$yaz->resim' class='w3-left w3-margin-right' style='width:100px'>
					...
					<div class="w3-card w3-margin">
						...
						<ul class="w3-ul w3-hoverable w3-white">
							...
							while($yaz=mysql_fetch_object($sorgu)){								
								...
								echo "<li class='w3-padding-16'>
										<a href='".Site_url_index_vulnurable."/index.php?sayfa=yazi/$yaz->url'>
											<img src='".Site_url_index_vulnurable."/images/kategori/$yaz2->resim' class='w3-left w3-margin-right' style='width:50px'>
											<span class='w3-large'>$yaz->baslik</span><br>
											<span>$yaz->tarih</span>
										</a>
									</li>";
					...
					<?php 
						if($url[0]=="" or $url[0]=="anasayfa"){
							...
							for($i=1;$i<ceil($toplam/$per_page)+1;$i++){
								if($sayfa==$i){
									echo "<a href='".Site_url_index_vulnurable."/index.php?sayfa=anasayfa/sayfa/$i' class='w3-button w3-black w3-disabled w3-padding-large w3-margin-bottom'>$i</a>";
								}else{
									echo "<a href='".Site_url_index_vulnurable."/index.php?sayfa=anasayfa/sayfa/$i' class='w3-button w3-black w3-padding-large w3-margin-bottom'>$i</a>";
								}
							} 
							echo "</div>";
						}else if($url[0]=="ara"){
							...
							while($yaz=mysql_fetch_object($sorgu)){
								...
								echo "<div class='w3-third w3-container w3-margin-bottom'>
										<a href='".Site_url_index_vulnurable."/index.php?sayfa=yazi/$yaz->url'>
											<img src='".Site_url_index_vulnurable."/images/kategori/$yaz2->resim' alt='Norway' style='width:100%' class='w3-hover-opacity'>
										</a>
										<div class='w3-container w3-white'>
											<p><b>$yaz->baslik</b></p>
											<p>$icerik</p>
							...
							if($yazi=="yok"){
								echo "<script>window.location.href='".Site_url_index_vulnurable."';</script>";
							}
							...
							if($toplam>0){
								...
								echo "	<div class='w3-card-4 w3-margin w3-white'>
											<img src='".Site_url_index_vulnurable."/images/kategori/$yaz2->resim' style='width:100%'>
							...
							for($i=1;$i<ceil($toplam/$per_page)+1;$i++){
								if($sayfa==$i){
									echo "<a href='".Site_url_index_vulnurable."/index.php?sayfa=kategori/$url1/sayfa/$i' class='w3-button w3-black w3-disabled w3-padding-large w3-margin-bottom'>$i</a>";
								}else{
									echo "<a href='".Site_url_index_vulnurable."/index.php?sayfa=kategori/$url1/sayfa/$i' class='w3-button w3-black w3-padding-large w3-margin-bottom'>$i</a>";
								}
							} 
							echo "</div>";
						}
